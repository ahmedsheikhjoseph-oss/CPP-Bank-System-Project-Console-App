...
using namespace std;
const string ClientsFileName = "Clients.txt";  // Standard delimiter for data separation in the text file
...
struct sClient
{
    ...
    bool MarkForDelete = false; // Logical delete flag
};
...
sClient ConvertLinetoRecord(string Line, string Seperator = "#//#")
{
    ...
    Client.AccountBalance = stod(vClientData[4]); // String to Double conversion
    return Client;
}
